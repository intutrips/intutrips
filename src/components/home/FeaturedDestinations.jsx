      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          <h2 className="text-4xl md:text-5xl font-light text-[#1A1A1A] mt-4 mb-6">
            Explore a <span className="italic">Ásia</span> conosco
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto font-light">Cada roteiro é cuidadosamente planejado e testado pessoalmente para oferecer experiências autênticas, com o conforto de viajar em um grupo pequeno de brasileiros.
