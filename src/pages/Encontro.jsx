...
function CTAButton({ href = EVENTO.linkIngresso, children, className = '' }) {
  return (
    <a href={href} target={href.startsWith('http') ? '_blank' : '_self'} rel="noopener noreferrer">
      <button className={`inline-flex items-center gap-2 px-8 py-4 rounded-full font-semibold text-base transition-all duration-200 bg-[#bda94c] hover:bg-[#a8922e] text-[#1A1A1A] shadow-lg hover:shadow-xl hover:-translate-y-0.5 ${className}`}>
        {children}
      </button>
    </a>
  );
...
const MOMENTOS = [
  ...
  },
  {
    ...
    desc: 'Baixar o volume do mundo para ouvir a voz que estava lá o tempo todo.',
    detalhe: 'Práticas guiadas de introspecção para acessar o que o barulho do dia cobre. O sinal já está lá. A noite ajuda a sintonizar.',
  },
  {
    num: '03',
    titulo: 'Escuta e Transformação',
    desc: 'Ser ouvida de um jeito que quase não existe mais.',
...
const FAQS = [
  {
    ...
    a: 'Não. Tudo é conduzido do zero, passo a passo. Você não precisa ter nenhuma experiência anterior. Só estar aberta ao que a noite propõe.',
  },
  {
  ...
  {
    q: 'Isso é terapia?',
    a: 'Não. Uma noite de reconexão e presença. Não substitui acompanhamento terapêutico ou psicológico. E também não compete com ele.',
  },
  {
    q: 'E se eu precisar cancelar?',
    a: 'Cancelamentos com mais de 7 dias de antecedência têm reembolso integral. Após esse prazo, é possível transferir o ingresso para outra pessoa ou usá-lo como crédito na próxima edição.',
  },
];
...
function FAQItem({ q, a }) {
  ...
  return (
    <div className="border-b border-gray-100 last:border-0">
      ...
      >
        <span className="text-[#3C3333] font-medium leading-snug">{q}</span>
...
export default function Encontro() {
  return (
    <div className="bg-[#FAF8F5] min-h-screen">
      ...
      {/* ── 1. HERO ───────────────────────────────────────────── */}
      <section className="relative min-h-[92vh] flex flex-col items-center justify-center text-center overflow-hidden bg-[#1B3028]">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=1920&q=80')] bg-cover bg-center opacity-20" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#1B3028]/70 via-[#1B3028]/40 to-[#1B3028]/95" />
        ...
        <div className="relative z-10 px-6 max-w-2xl mx-auto">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-white/60 text-lg md:text-xl font-light leading-relaxed mb-10 max-w-xl mx-auto">
              Uma noite para reencontrar a sua bússola interna e recomeçar o ano de dentro para fora,
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <span className="text-white/35 text-sm">Vagas limitadas. Os primeiros a se inscrever garantem o 1º lote.</span>
            </motion.div>
          </motion.div>
        </div>
      ...
      <Section className="py-20 md:py-28">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-2xl md:text-3xl text-[#3C3333] font-light leading-relaxed">
          ...
          <motion.p variants={fadeUp} className="text-2xl md:text-3xl text-[#3C3333] font-light mt-8 italic">
      ...
      {/* ── 3. A VIRADA ───────────────────────────────────────── */}
      <section className="py-20 md:py-28 bg-[#2D4A3E]">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="mt-10 pl-6 border-l-2 border-[#bda94c]">
              <p className="text-lg md:text-xl text-white/80 font-light leading-relaxed">
                Este encontro não veio para te dar mais uma meta para cumprir.
                Veio para te ajudar a reencontrar a bússola que já está dentro de você.
                A intuição que sempre soube o caminho, mesmo quando o barulho tapou o sinal.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <Section className="py-20 md:py-28">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-light text-[#3C3333] mb-8 leading-snug">
            Uma noite pra você se lembrar<br />de quem é e o que está fazendo aqui.
          </motion.h2>
          ...
          <motion.p variants={fadeUp} className="text-xl text-[#3C3333] font-light leading-relaxed">
            São no máximo {EVENTO.vagas} pessoas vivendo juntas algumas horas de reconexão profunda,
      ...
      <section className="py-20 md:py-28 bg-[#FAF8F5]">
        <div className="px-6 md:px-12 max-w-3xl mx-auto">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-light text-[#3C3333] mb-12 leading-snug">
              Quatro momentos.<br />Uma virada.
            </motion.h2>
            ...
            <div className="space-y-8">
              {MOMENTOS.map((m, i) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-[#3C3333] mb-1">{m.titulo}</h3>
            ...
            <motion.div variants={fadeUp} className="mt-12 p-6 bg-[#2D4A3E] rounded-2xl">
        ...
        <div className="px-6 md:px-12 max-w-3xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="space-y-5 text-gray-600 font-light leading-relaxed text-lg">
              <p>
                A Intu é uma ponte. Levamos você ao mundo para que o mundo te devolva a você.
              </p>
              <p>
                Porque as respostas que você procura lá fora já vivem aí dentro,
                e a intuição é o caminho de volta até elas.
              </p>
              <p>
                O encontro é a metade interior dessa ponte, vivida numa noite em São Paulo.
                A expedição é a metade exterior, vivida do outro lado do mundo.
                Quem cruza uma sente vontade de cruzar a outra.
              </p>
              <p className="text-[#3C3333] italic">
                O nome Intu não é por acaso. Vem de intuição. Sempre foi.
              </p>
            </motion.div>
      ...
      <Section className="py-20 md:py-28">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-light text-[#3C3333] mb-10 leading-snug">
      ...
      <section className="py-20 md:py-28 bg-[#2D4A3E]">
        <div className="px-6 md:px-12 max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <motion.div variants={fadeUp}>
                <p className="text-xs uppercase tracking-widest text-[#6b9faf] font-semibold mb-4">Por dentro</p>
                <div className="space-y-4">
                  {[
                    'Acesso à sua própria intuição, a bússola que já estava lá',
                    'Mais clareza para reconhecer o próximo passo quando ele aparecer',
                    'O alívio de ter parado para se ouvir de verdade',
                    'A sensação de ter voltado pra si',
                  ].map(t => (
                    <div key={t} className="flex items-start gap-3">
              ...
              <motion.div variants={fadeUp}>
                <p className="text-xs uppercase tracking-widest text-[#6b9faf] font-semibold mb-4">Por fora</p>
                <div className="space-y-4">
                  {[
      ...
      <Section className="py-20 md:py-28">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-3xl font-light text-[#3C3333] mb-10">
      ...
      <section id="ingresso" className="py-20 md:py-28 bg-[#FAF8F5]">
        <div className="px-6 md:px-12 max-w-3xl mx-auto">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-light text-[#3C3333] mb-4 leading-snug">
            ...
            <motion.div variants={fadeUp} className="grid md:grid-cols-2 gap-5">
              <div className="bg-white border-2 border-[#bda94c] rounded-2xl p-7 relative overflow-hidden">
                ...
                <p className="text-5xl font-light text-[#3C3333] mb-1">{EVENTO.lotePrimeiroValor}</p>
      ...
      {/* ── 13. FECHAMENTO ────────────────────────────────────── */}
      <section className="py-24 md:py-32 bg-[#2D4A3E] text-center">
      ...
      {/* ── 14. RODAPÉ DO EVENTO ──────────────────────────────── */}
      <section className="py-12 bg-[#1B3028]">
