      ...
      <section className="max-w-2xl mx-auto px-6 py-10 space-y-6">
        ...
        <div className="text-center space-y-3 pt-4">
          ...
          <div className="flex justify-center gap-4">
            <a
              href={`https://wa.me/551151233225?text=${encodeURIComponent(selected ? `Olá, simulei o valor da expedição ${selected.name} na página de simulação da Intu Trips e gostaria de mais informações.` : 'Olá! Vim do simulador de viagens da Intu Trips e gostaria de saber mais sobre os destinos disponíveis.')}`}
              target="_blank"
