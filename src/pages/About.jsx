...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-[#f8eee5]">
      ...
      {/* ── Hero ── */}
      <section className="pt-32 pb-20 px-6 bg-[#92314D] relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="text-center p-8">
                <div className="w-16 h-16 rounded-2xl bg-[#f8eee5] flex items-center justify-center mx-auto mb-6">
                  <value.icon className="text-[#92314D] h-7 w-7" />
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-light text-[#3C3333]">
              ...
              <span className="italic text-[#6b9faf]">{texts.about_forwhom_title2 || 'é a Intu'}</span>
            </h2>
          </motion.div>

          <div className="grid md:grid-cols-2 gap-8">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-gradient-to-br from-[#6b9faf] to-[#92314D] rounded-2xl p-8 text-white">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-[#f8eee5] rounded-2xl p-8 border-2 border-gray-200">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center text-gray-600 font-light mt-12 text-lg max-w-3xl mx-auto">
            ...
            <span className="block mt-4 text-[#6b9faf] font-medium italic">
      ...
      {/* ── CTA ── */}
      <section className="py-24 px-6 bg-[#92314D] relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#6b9faf]/10 rounded-full translate-x-1/2 -translate-y-1/2" />
        <div className="max-w-4xl mx-auto text-center relative">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Sparkles className="h-10 w-10 text-[#6b9faf] mx-auto mb-6" />
            <h2 className="text-3xl md:text-5xl font-light text-white mb-6">
              {texts.about_cta_title1 || 'Pronto para ver o'}<br />
              <span className="italic text-[#6b9faf]">{texts.about_cta_title2 || 'mundo real?'}</span>
            </h2>
